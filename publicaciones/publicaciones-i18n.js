(function () {
  ...
  const ARTICLE_TRANSLATIONS = {
    'acuerdo-interinstitucional-fifa-2026-facilidad-aduanera.html': {
      ...
      content: `
        ...
        <p>This is the least publicly discussed element of the Agreement and the one that matters most for companies operating under this framework.</p>
        ...
        <h2>Immediate and long-term consequences</h2>
        <p>The immediate consequence for authorized companies is operational: they may clear goods without obtaining individual prior permits, by submitting the free-form statement to the customs authorities. That directly reduces time and cost.</p>
        <p>The immediate consequence for anyone who signs without verification is exposure. A sworn statement that does not match the actual condition of the goods, because the goods fail to meet the health, environmental, or safety requirements declared as satisfied, creates responsibility from the moment of clearance, not from the moment the authority detects the issue.</p>
        <p>The most relevant long-term consequence is set out in Article Four of the Agreement: the signatory agencies must coordinate to implement the facilitation measures, without prejudice to exercising their powers of control, surveillance, detection, and verification. Control does not disappear; it is deferred and concentrated. Companies that operated under this framework throughout the event may face later reviews of the goods imported and the conditions they declared as satisfied.</p>
        <p>The Agreement expires on December 31, 2026. The responsibilities arising from statements filed under it do not expire with it.</p>
        <h2>The real value of FIFA 2026 customs facilitation</h2>
        <p>The Interagency Agreement is useful when it is used correctly. It enables faster operations in a high-pressure logistics environment. It reduces administrative friction without eliminating the underlying obligations.</p>
        <p>Its real value depends on a condition that is not expressly written into the text but follows from its structure: the authorized importer must actually verify, before signing, that the goods comply with the conditions being declared. Not as a formality, but as a practice.</p>
        <p>The importer that performs that verification gains a genuine operational advantage. The importer that does not creates a legal exposure amplified by the Agreement itself, because the sworn statement turns a technical non-compliance issue into a false statement before an authority.</p>
      `
    },
    ...
    'cierre-regimen-fifa-2026-31-diciembre.html': {
      ...
      content: `
        ...
        <p>During the life of the regime, companies naturally focused on operations: obtaining authorizations, moving goods, providing services, invoicing under the correct structure. That was urgent.</p>
        <p>Closing is what determines whether all of that becomes value or exposure.</p>
        <p>A properly applied tax benefit that is poorly documented is indistinguishable, from an audit perspective, from an improperly applied benefit. The Tax Administration Service does not review intentions; it reviews documentary support.</p>
        <p>Companies that participated in the FIFA World Cup 2026 value chain have until December 31, 2026 to build that support contemporaneously. After that date, the regime ceases to exist. And with it, the possibility of acting within the legal logic that created it.</p>
      `
    },
    'conversacion-tecnica-antes-despacho.html': {
      ...
      content: `
        ...
        <h2>Operational prevention</h2>
        <p>Prevention does not eliminate every risk, but it gives the company a better basis for decision-making. When the position is documented, the customs broker has clearer instructions, internal teams understand the reasons for the decision, and the company is better prepared to respond to a review.</p>
        <p>In customs matters, speed without technical clarity is not efficiency. It is exposure disguised as speed.</p>
      `
    },
    'desafio-migratorio-mexico.html': {
      ...
      content: `
        ...
        <p>Immigration procedures interact with labor, tax, corporate, family, and foreign trade matters more often than is usually recognized. A foreign executive assigned to Mexico, a family seeking residence, an investor opening operations, or a specialized technician entering for a project may all require coordination beyond the migration authority itself.</p>
        <p>That is why migration should be analyzed as part of the broader legal and business context, not as an isolated administrative step.</p>
        <h2>What should be reviewed in advance</h2>
        <ul><li>The purpose of entry and the activities to be carried out in Mexico.</li><li>The correct condition of stay and its permitted scope.</li><li>Employer registration, corporate sponsorship, or family documentation where applicable.</li><li>Timing, renewals, exits, and changes of status.</li><li>Evidence that supports the facts declared to the authority.</li></ul>
        <h2>A present challenge</h2>
        <p>Mexico's migration challenge is not limited to border flows or public policy debates. It is also present in day-to-day business operations, family decisions, investment projects, and professional mobility.</p>
        <p>Addressing it properly requires treating each case with legal precision and practical judgment. Immigration advice has value when it gives people and organizations clarity about what can be done, what should be documented, and what risks should be managed before they become urgent.</p>
      `
    },
    'empresas-operaciones-mixtas-fifa-2026.html': {
      ...
      content: `
        ...
        <p>The company must be able to show which income, expenses, contracts, invoices, payments, and supporting documents correspond to FIFA 2026 and which correspond to ordinary operations. Without that separation, the benefit becomes vulnerable in a later review.</p>
        <h2>Deductions and expenses</h2>
        <p>Expenses related to ordinary operations must remain within the ordinary tax regime. Expenses linked to FIFA 2026 must be supported by the specific documents, authorizations, and factual circumstances that justify their treatment under the special regime.</p>
        <p>The practical issue is allocation. Shared costs, mixed contracts, personnel, logistics, storage, transportation, and professional services must be analyzed carefully to determine whether they correspond fully to one activity or require a reasonable, documented allocation.</p>
        <h2>VAT crediting in mixed activities</h2>
        <p>VAT crediting becomes particularly sensitive when taxable, exempt, and specially treated activities coexist. A company cannot assume that all VAT paid on inputs is creditable in full merely because one part of its business is linked to FIFA 2026.</p>
        <p>The company must review the nature of each activity, the destination of each acquisition, and the documentary support connecting the input to the corresponding revenue or operation. In practice, this requires contemporaneous controls, not year-end reconstruction.</p>
        <h2>The value of preparing the file before the audit</h2>
        <p>The tax benefit may be valid, but the audit will be documentary. The relevant question will not be whether the company participated in FIFA 2026 in a general sense. It will be whether each benefit, deduction, exemption, or VAT credit can be traced to a qualifying activity and supported by records created at the time of the operation.</p>
        <p>For companies with mixed operations, the safest approach is to design the accounting and tax file before the transactions occur. Waiting until the close of the year turns traceability into reconstruction, and reconstruction is always weaker than contemporaneous documentation.</p>
      `
    },
    'importar-mundial-expediente-aduana.html': {
      ...
      content: `
        ...
        <p>Clearance cannot take place through any customs office. Rule 4.2.21 of the General Foreign Trade Rules for 2026 establishes a closed list of twenty authorized customs offices: Cancun, Ciudad Juarez, Ciudad Miguel Aleman, Ciudad Reynosa, Colombia, Guadalajara, Lazaro Cardenas, Manzanillo, Mexicali, Mexico City, Monterrey, Nogales, Nuevo Laredo, Piedras Negras, Salina Cruz, Tijuana, Toluca, Veracruz, Mexico City International Airport, and Felipe Angeles International Airport.</p>
        <p>The authorization will specify which of those customs offices the importer may use. Clearance may be carried out only through the customs offices identified in the authorization, not through any of the twenty at the importer's discretion.</p>
        <h2>Exceptions to the return obligation</h2>
        <p>Not all goods imported under Filing 146/LA must be returned abroad. The regime recognizes three exceptions.</p>
        <p>The first applies to goods that, by their nature, are consumed during the FIFA World Cup 2026 and related events.</p>
        <p>The second applies to goods distributed free of charge among attendees or participants, provided they are individually identified with FIFA World Cup 2026 logos or marks and the legend "Free distribution. Individual sale prohibited."</p>
        <p>The third applies to goods later donated to the Federation, states, municipalities, territorial districts of Mexico City, public bodies, or non-profit legal entities and trusts authorized to receive donations under the Income Tax Law. For this scenario, FWC2026 Mexico, S. de R.L. de C.V. must submit a free-form letter to the Legal Affairs Directorate for Customs of the National Customs Agency of Mexico no later than December 31, 2026, with the importer information, date and customs office of entry, form folio number, and final recipient information.</p>
        <h2>Non-tariff regulations and the Interagency Agreement</h2>
        <p>One additional complexity is that temporarily imported goods may be subject to non-tariff regulations and restrictions: health, phytosanitary, safety, or environmental permits that normally require individual filings before multiple agencies.</p>
        <p>The Interagency Agreement published in the Federal Official Gazette on August 6, 2025 partially addressed this complexity. Authorized persons may evidence compliance with those regulations through a written sworn statement, without obtaining each permit individually.</p>
        <p>This facilitation does not eliminate responsibility. The company signing the statement assumes the obligation that the goods actually comply with the conditions required by each applicable regulation. If the goods do not meet those conditions, the company is responsible under the applicable legal provisions, including those relating to public health, safety, animal and plant health, and the environment.</p>
        <h2>What the file must include</h2>
        <p>The Filing 146/LA application requires specific documentation that must be assembled before submission to the National Customs Agency of Mexico:</p>
        <ul><li>A free-form letter with importation dates, customs offices for clearance, and, where applicable, the sworn statement regarding non-tariff regulations.</li><li>Authorization from FWC2026 Mexico, S. de R.L. de C.V. identifying the event, locations, and dates of use of the goods.</li><li>A detailed list of goods in Excel format, including description, tariff classification, commercial identification number, quantity, and unit value, specifying which goods will be consumed, distributed free of charge, or donated.</li><li>Document evidencing the authority of the person submitting the application.</li><li>Consent letter from FWC2026 Mexico, S. de R.L. de C.V. committing to return the goods abroad no later than December 31, 2026.</li><li>Official identification.</li></ul>
        <p>Documents in a foreign language must be accompanied by a Spanish translation.</p>
        <h2>The consequence of operating without a file</h2>
        <p>The regime does not apply merely because a company is connected to the event. It applies to those who can prove, with documents, that they met the conditions, obtained authorization, respected the deadlines, and cleared the goods through the correct customs office.</p>
        <p>Goods imported without a valid Filing 146/LA authorization are not covered by the special regime. Goods that do not return within the authorized period and do not fall within an exception are unlawfully present in Mexico. A sworn statement that does not match the actual condition of the goods creates administrative and criminal responsibility for the person who signed it.</p>
        <p>The advantage of the regime is real. So is the risk of using it without documentary support.</p>
      `
    },
    'incoterms-punto-partida-operativo.html': {
      ...
      content: `
        ...
        <h2>They are not mandatory, but ignoring them is costly</h2>
        <p>Incoterms are voluntary. They have practical and contractual effect when properly incorporated into the transaction. Form matters: writing EXW or FOB in isolation is not enough. The correct approach is to identify the place and version, for example: EXW Mexico City, Incoterms 2020.</p>
        <p>The absence of Incoterms does not invalidate an international sale, but it may increase the risk of contradictory interpretations. Banks, insurers, carriers, and logistics operators commonly use them as a standard reference.</p>
        <h2>Operational families</h2>
        <ul><li>E: EXW. The seller delivers at its premises and the buyer assumes practically the entire operation.</li><li>F: FCA, FAS, and FOB. The seller delivers to the carrier or at the agreed point; the buyer contracts the main carriage.</li><li>C: CFR, CIF, CPT, and CIP. The seller pays for carriage, but risk transfers before destination.</li><li>D: DAP, DPU, and DDP. The seller assumes costs and risks through destination; DDP includes import-related obligations.</li></ul>
        <h2>The most common mistake</h2>
        <p>Choosing EXW because it seems simple. It may look convenient, but if the buyer does not properly manage export formalities, the seller may face tax or documentary issues in its own country.</p>
        <p>The Incoterm should be selected during commercial negotiation, not afterward. Commercial, logistics, finance, and foreign trade teams should participate. Three letters can replace pages of contract language, but only when chosen with judgment.</p>
      `
    },
    'manifestacion-valor-defensa-anticipada.html': {
      ...
      content: `
        ...
        <p>Advance defense means preparing the explanation before a dispute exists. It does not mean litigating in advance; it means documenting in an orderly way so that, if the transaction is reviewed, the company does not depend on memory, scattered emails, or late reconstruction.</p>
        <ul><li>Identify supporting documents by transaction.</li><li>Review expenses that must be added to customs value.</li><li>Document special commercial conditions.</li><li>Validate consistency among invoice, payment, and customs entry.</li><li>Preserve evidence of transport, insurance, and related services.</li></ul>
        <p>The Customs Value Declaration is not a minor filing. It is an internal control tool and a first line of defense in post-clearance reviews.</p>
      `
    },
    'paquete-normativo-fifa-2026.html': {
      ...
      content: `
        ...
        <p>International mobility should not be resolved at the counter. It should be integrated into project planning, especially when the activity in Mexico is not purely tourism.</p>
        <h2>Compliance and traceability</h2>
        <p>Compliance is not just filling out forms. It is the ability to explain, with documents, why an operation was eligible, who authorized it, which goods or services it involved, and how it was closed.</p>
        <ul><li>Contracts aligned with the actual operation.</li><li>Complete tax and customs files.</li><li>Support for authorized beneficiaries and participants.</li><li>Control of dates, deadlines, returns, and closing steps.</li><li>Prior immigration review for foreign personnel.</li></ul>
        <p>FIFA 2026 will be an economic opportunity, but also a test of regulatory maturity. Companies that document from the outset will reduce friction, costs, and contingencies. Those that improvise may discover too late that the event does not suspend the rules; it concentrates them.</p>
      `
    },
    'regimen-fifa-2026.html': {
      ...
      content: `
        ...
        <h2>What companies should review</h2>
        <ul><li>Whether their participation is directly linked to the FIFA 2026 event.</li><li>Which goods, services, or activities fall within the temporary regime.</li><li>Which authorizations, forms, or notices must be included in the file.</li><li>How tax, customs, and contractual traceability will be documented.</li><li>What happens when the regime expires.</li></ul>
        <p>When the regime expires, there will not necessarily be a visible repeal for each operation. The temporary route will simply cease to exist. Planning must therefore include closing: return, regularization, destruction, change of regime, or documentary completion, as applicable.</p>
        <p>The advantage of this regime is that it creates operational certainty. The risk is assuming that certainty operates automatically. In reality, it operates only for those who can prove they meet the regime's conditions and executed their operations with sufficient documentary support.</p>
      `
    },
    'tmec-2026-reglas-origen.html': {
      ...
      content: `
        ...
        <h2>Rules of origin deserve special attention</h2>
        <p>Among all the issues on the table, rules of origin appear to concentrate much of the attention.</p>
        <p>Why?</p>
        <p>Because they determine whether goods may receive USMCA preferential tariff treatment.</p>
        <p>If they become stricter in the future, many companies may need to review suppliers, supply chains, production processes, and supporting documentation.</p>
        <p>That does not mean it will happen tomorrow. Nor does it mean the agreement is at risk.</p>
        <p>It simply means this is an issue worth watching closely.</p>
        <h2>USMCA does not appear to be in danger</h2>
        <p>Despite some alarmist messages circulating in media and social networks, there are currently no formal signals of a real intention to terminate the agreement.</p>
        <p>The reason is simple: the economies of Mexico, the United States, and Canada are deeply integrated.</p>
        <p>Automobiles, medical devices, electronics, advanced manufacturing, and agriculture are part of supply chains that operate across the three countries' borders every day.</p>
        <p>For that reason, the most likely scenario is not the disappearance of USMCA, but targeted adjustments in specific sectors or chapters.</p>
        <h2>What companies should review now</h2>
        <p>Beyond the political negotiations, this is a good moment for internal review.</p>
        <p>Particularly for manufacturers, exporters, IMMEX companies, and suppliers in international chains.</p>
        <p>Useful questions include:</p>
        <ul><li>Do we really know the origin of our inputs?</li><li>Is our origin documentation complete and up to date?</li><li>Are we overly dependent on suppliers outside North America?</li><li>Could we prove origin compliance in an audit or verification?</li></ul>
        <p>These questions are often postponed until a review or formal verification occurs.</p>
        <h2>The opportunity behind the review</h2>
        <p>Every trade review creates uncertainty, but it also creates opportunities.</p>
        <p>Mexico remains one of the region's most important manufacturing centers and continues to play a fundamental role in North American supply chains.</p>
        <p>Rather than focusing on extreme scenarios, companies should use this moment to strengthen compliance processes and prepare for any adjustment that may eventually arise.</p>
        <h2>Our view</h2>
        <p>From an international trade perspective, it is still premature to anticipate definitive changes.</p>
        <p>However, it is clear that rules of origin will continue to occupy a central place in the conversations.</p>
        <p>Importers, exporters, and IMMEX companies should therefore monitor the negotiations and begin assessing their risks and strengths now.</p>
        <p>The companies that understand the potential impact of these changes first will also be the best positioned to capture the opportunities arising from the 2026 USMCA review.</p>
      `
    }
  };
  ...
  const INDEX_UI = {
    es: {
      currentTopic: 'Tema de actualidad',
      recent: 'Analisis recientes',
      allArticles: 'Ver todos los articulos ->',
      conversationTitle: 'CONVERSEMOS',
      conversationText: 'Tiene una perspectiva distinta, una experiencia relacionada o una pregunta sobre este tema?<br><br>La regulacion y los negocios rara vez ofrecen respuestas universales. Cada situacion merece un analisis cuidadoso.',
      conversationAction: 'Iniciar conversacion ->',
      legal: 'Contenido informativo. No constituye asesoria legal.',
      filters: {
        'Todos': 'Todos',
        'Comercio Exterior': 'Comercio Exterior',
        'Regulacion': 'Regulacion',
        'Migracion': 'Migracion',
        'Patrimonio y Familia': 'Patrimonio y Familia'
      }
    },
    en: {
      ...
      conversationTitle: 'LET US TALK',
      conversationText: 'Do you have a different perspective, related experience, or a question about this topic?<br><br>Regulation and business rarely offer universal answers. Every situation deserves careful analysis.',
      conversationAction: 'Start a conversation ->',
      legal: 'Informational content. This does not constitute legal advice.',
      filters: {
        'Todos': 'All',
        'Comercio Exterior': 'International Trade',
        'Regulacion': 'Regulation',
        'Migracion': 'Immigration',
        'Patrimonio y Familia': 'Estate and Family'
      }
    }
  };
  ...
  function applyPublicationsLanguage(lang) {
    const nextLang = lang === 'en' ? 'en' : 'es';
    document.documentElement.lang = nextLang;
    document.querySelectorAll('.lang-btn').forEach((button) => {
      button.classList.toggle('active', button.textContent.trim().toLowerCase() === nextLang);
    });
    document.querySelectorAll('[data-es]').forEach((el) => {
      const value = el.getAttribute('data-' + nextLang);
      if (value) el.innerHTML = value;
    });
    updateArticle(nextLang);
    updateIndex(nextLang);
  }

  const previousSetLang = window.setLang;
  window.setLang = function (lang) {
    if (typeof previousSetLang === 'function') {
      previousSetLang(lang);
    }
